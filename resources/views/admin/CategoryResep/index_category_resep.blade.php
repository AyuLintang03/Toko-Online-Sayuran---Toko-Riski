                    ...
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            ...
                            <ul class="cat-sub-menu">
                                ...
                                <li>
                                    <a class="active" href="{{route('admin.index_category_resep')}}">Kategor Resep</a>
                                </li>
                            </ul>
                        </li>
                        <li>
  ...
  <div class="container main-nav">
    <div class="main-nav-start">
      <div class="search-wrapper">
        <form action="{{ route('admin.searchcategoryresep') }}" method="GET">
...
<main class="main users chart-page" id="skip-target">           
    <div class="container">
        <h2 class="main-title">Kategori Resep</h2>
        <div class="row">
            <div class="col-lg-9">
                <div class="col-lg-9">
                 <button class="btn-create">
                  <a href="{{route('admin.create_category_resep')}}">Tambah</a></button>
                 </div>
                <div class="users-table table-wrapper">
                    <table class="posts-table">
                        ...
                        <tbody>
                             @foreach ($categoryreseps as $categoryresep)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{$categoryresep->name_category_resep}}</td>
                                <td><img src="{{url('storage/' . $categoryresep->image_category_resep)}}" alt=""></td>
                                <td>            
                                    <span class="p-relative">
                                            <ul class="icon-container">     
                                                <li><a href="{{route('admin.edit_category_resep',$categoryresep)}}"><i class="fa fa-pencil" style="color: #004dd1; font-size: 24px; cursor:pointer;cursor:pointer; "  title="Edit"></i></a></li>
                                               <form onclick="confirmDelete('{{ route('admin.delete_category_resep', $categoryresep) }}')" action="{{ route('admin.delete_category_resep', $categoryresep) }}" method="post">
                                                @csrf
                                                 @method('DELETE')
