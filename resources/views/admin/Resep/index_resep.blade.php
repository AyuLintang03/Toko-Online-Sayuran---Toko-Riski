            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a href="{{route('admin.index_resep')}}" class="active">
  ...
  <div class="container main-nav">
    <div class="main-nav-start">
      <div class="search-wrapper">
        <form action="{{ route('admin.searchresep') }}" method="GET">
...
<main class="main users chart-page" id="skip-target">           
    <div class="container">
        <h2 class="main-title">Resep</h2>
        <div class="row">
            <div class="col-lg-9">
                <div class="col-lg-9">
                 <button class="btn-create">
                  <a href="{{route('admin.create_resep')}}">Tambah</a></button>
                 </div>
                    ...
                    <table class="posts-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$resep->name}}</td>
                                <td style="overflow:hidden; max-width:200px; text-overflow:ellipsis;">{{$resep->description}}</td>
                                <td>{{$resep->price}}</td>
                                <td><img src="{{url('storage/' . $resep->image)}}" alt=""></td>
                                <td>{{$resep->category_resep->name_category_resep}}</td>
                                <td>            
                                    <span class="p-relative">    
                                            <ul  class="icon-container">     
                                                <li><a href="{{route('admin.edit_resep',$resep)}}"><i class="fa fa-pencil" style="color: #004dd1; font-size: 24px; cursor:pointer;cursor:pointer; "  title="Edit"></i></a></li>
                                                <form onclick="confirmDelete('{{ route('admin.delete_resep', $resep) }}')" action="{{ route('admin.delete_resep', $resep) }}" method="post">
                                                @csrf
                                                @method('delete')
