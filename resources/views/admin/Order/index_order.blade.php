...
<main class="main users chart-page" id="skip-target">           
    <div class="container">
        <h2 class="main-title">Pemesanan</h2>
        <div class="row">
            <div class="col-lg-9">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               @if($order->status === 'Konfirmasi')
                                  <td><span class="badge badge-active ">{{$order->status}}</span></td>
                               @elseif ($order->status === 'Lunas')
                                ...
                                @elseif ($order->status === 'Diterima')
                                  ...
                                  <td><span class="badge badge-disabled">{{$order->status}}</span></td>
                               @else
                                  <td><span class="badge badge-trashed ">{{$order->status}}</span></td>
                               @endif
                                <td>            
                                    <span class="p-relative">       
                                            <ul   class="icon-container">     
                                                <li><a href="{{ route('admin.show_order', $order) }}"
                                                onclick="showOverlay('orderDetailsOverlay');"
                                                class="transaction-detail-link"
                                                data-order-id="{{ $order->id }}"
                                                data-order-user="{{ $order->user->username }}"><i class="fa fa-info-circle" style="color: #0066eef; font-size: 24px; cursor:pointer;cursor:pointer; "  title="Lihat"></i></a></li>
                                                 <li><a href="{{route('admin.edit_order',$order)}}"><i class="fa fa-pencil" style="color: #004dd1; font-size: 24px; cursor:pointer;cursor:pointer; "  title="Edit"></i></a></li>
