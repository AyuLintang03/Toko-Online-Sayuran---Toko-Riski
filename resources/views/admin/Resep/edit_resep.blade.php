      ...
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.update_resep',$resep)}}" method="post" enctype="multipart/form-data">
                @method('patch')              
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" placeholder="Name" class="form-control" value="{{$resep->name}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="price" placeholder="Harga" class="form-control" value="{{$resep->price}}">
                </div>
                <div class="form-group">
                  <label>Gambar Resep</label>
                  <input type="file" name="image" class="form-control" value="{{$resep->image}}">
                </div>
