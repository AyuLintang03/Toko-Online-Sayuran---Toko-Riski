            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a href="{{route('admin.index_delivery')}}" class="active">
  ...
  <div class="container main-nav">
    <div class="main-nav-start">
      <div class="search-wrapper">
        <form action="{{ route('admin.searchdelivery') }}" method="GET">
...
<main class="main users chart-page" id="skip-target">           
    <div class="container">
        <h2 class="main-title">Pengiriman</h2>
        <div class="row">
            <div class="col-lg-9">
              <div class="col-lg-9">
                 <button class="btn-create">
                  <a href="{{route('admin.createdelivery')}}">Tambah</a></button>
                 </div>
                                ...
                                <td>            
                                    <span class="p-relative">     
                                            <ul   class="icon-container">     
                                             <li><a href="{{route('admin.editdelivery',$delivery)}}"><i class="fa fa-pencil" style="color: #004dd1; font-size: 24px; cursor:pointer;cursor:pointer; "  title="Edit"></i></a></li>
                                             
                                              <!--  <form onclick="confirmDelete('{{ route('admin.destroy_delivery', $delivery) }}')" action="{{ route('admin.destroy_delivery', $delivery) }}" method="post">
                                                @csrf
                                                 @method('DELETE')
                                               <li><a class="delete-icon"><i class="fa fa-trash fa-lg" style="color: #ff0000; font-size: 24px; cursor:pointer"></i></a></li></form>-->
                                            </ul>         
                                    </span>
                                </td>
                            </tr>
