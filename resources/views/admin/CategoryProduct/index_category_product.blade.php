                    ...
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            ...
                            <ul class="cat-sub-menu">
                                <li>
                                    <a class="active" href="{{route('admin.index_category_product')}}" >Kategor Barang</a>
                                </li>
                                <li>
  ...
  <div class="container main-nav">
    <div class="main-nav-start">
      <div class="search-wrapper">
        <form action="{{ route('admin.searchcategoryproduct') }}" method="GET">
...
<main class="main users chart-page" id="skip-target">           
    <div class="container">
        <h2 class="main-title">Kategori Barang</h2>
        <div class="row">
            <div class="col-lg-9">
                <div class="col-lg-9">
                 <button class="btn-create">
                  <a href="{{route('admin.create_category_product')}}">Tambah</a></button>
                 </div>
                    ...
                    <table class="posts-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$categoryproduct->name_category_products}}</td>
                                <td><img src="{{url('storage/' . $categoryproduct->image_category_products)}}" alt=""></td>
                                <td>            
                                    <span class="p-relative">
                                      <div></div>
                                            <ul class="icon-container">  
                                                <li ><a href="{{route('admin.edit_category_product',$categoryproduct)}}"><i class="fa fa-pencil" style="color: #004dd1; font-size: 24px; cursor:pointer;cursor:pointer; "  title="Edit"></i></a></li>
                                                
                                               <form onclick="confirmDelete('{{ route('admin.delete_category_product', $categoryproduct->id) }}')" action="{{ route('admin.delete_category_product', $categoryproduct->id) }}" method="post">
                                                @csrf
                                                 @method('DELETE')
