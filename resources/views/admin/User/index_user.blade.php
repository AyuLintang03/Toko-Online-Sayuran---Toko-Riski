            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="show-cat-btn active" href="{{route('admin.index_user')}}">
...
<main class="main users chart-page" id="skip-target">           
    <div class="container">
        <h2 class="main-title">Pelanggan</h2>
        <div class="row">
            <div class="col-lg-9">
                               ...
                               <td>{{$user->email}}</td>
                                <td  >            
                                    <span class="p-relative">
                                            <ul>
                                               <form onclick="confirmDelete('{{route('admin.delete_user',$user->id)}}')" action="{{route('admin.delete_user',$user)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                <li><a><i class="fa fa-trash fa-lg" style="color: #ff0000; font-size: 24px; margin-top:10px; cursor:pointer; margin-left:10px; "title="Hapus"></i></a></li>
                                            </form>  
                                            </ul>         
                                    </span>
                                </td>
